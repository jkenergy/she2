...
she_errorcode_t FAST_CODE sm_sw_nvram_backdoor_set_key(sm_key_id_t key_number, const sm_block_t *key, uint16_t flags)
{
    ...
    sm_sw_nvram_fs_ptr->key_slots[key_number].flags = flags;
